...
from app.modules.balances.service.use_cases import CreateBalanceService, DeleteBalanceService, ManageBalanceService, ShowBalanceService
from app.modules.operations.service.use_cases import DepositBalanceService, ExchangeBalanceService, TransferBalanceService, WithdrawBalanceService
...
class BalanceServiceProvider(Provider):
    ...
    @provide
    def create_service(
        self, wallet_queries: WalletQueriesRepository, balance_commands: BalanceCommandsRepository, balance_queries: BalanceQueriesRepository
    ...
    @provide
    def delete_service(
        self, balance_commands: BalanceCommandsRepository, balance_queries: BalanceQueriesRepository, wallet_queries: WalletQueriesRepository
